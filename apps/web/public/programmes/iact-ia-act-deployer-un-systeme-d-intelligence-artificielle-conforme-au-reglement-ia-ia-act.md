...
- Comprendre les enjeux de l’IA, le RIA, les notions clefs (les systèmes d’IA, les publics visés par ce règlement, les risques, les exigences des SIA à haut risque et des autres SIA,...), les obligations des parties prenantes, les interactions RIA et RGPD
- Identifier les obligations des parties prenantes et la catégorisation des systèmes d’IA
- Appliquer les bonnes pratiques dans un système d’IA
- Assurer le rôle du DPO dans le déploiement d’un Système d’Intelligence Artificielle à travers un cas pratique
...
Prérequis de la fiche : Des connaissances préalables relatives au RGPD sont nécessaires pour suivre cette formation. Vous pouvez les acquérir à travers la formation RGPD - Comprendre le RGPD et mise en conformité (SPDP).

## Préparation de la formation

Connaissance des processus de l'organisation ; textes européens, ressources CNIL et dossier fictif. Les dates et interprétations sont vérifiées dans les textes en vigueur à la session.

## Cas fil rouge

Construire un dossier d'analyse réglementaire pour un système IA fictif utilisé dans le recrutement, puis identifier les validations nécessaires.
...
### Définir le périmètre du règlement IA · 210 min
...
### Organiser les exigences et les preuves · 210 min
...
### Préparer la supervision en exploitation · 210 min
...
- Les analyses renvoient à des dispositions et à une version des textes.
- Les responsabilités fournisseur et déployeur sont distinguées.
- Les conclusions incertaines et les validations manquantes sont explicites.
...
[Fiche officielle observée le 11 septembre 2026](https://beyond-expertise.com/formations/iact-ia-act-deployer-un-systeme-d-intelligence-artificielle-conforme-au-reglement-ia-ia-act)
...
- [EUR-Lex · règlement européen sur l'IA](https://eur-lex.europa.eu/eli/reg/2024/1689/oj/eng)
