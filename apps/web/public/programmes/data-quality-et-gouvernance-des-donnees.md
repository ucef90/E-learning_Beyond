...
Public : Data managers, data owners, responsables qualité, chefs de projet data, responsables SI.

Prérequis de la fiche : Avoir déjà participé à un projet data, BI ou SI.

## Préparation de la formation

Expérience data, BI ou SI ; référentiel fictif contenant doublons, erreurs et valeurs manquantes.

## Cas fil rouge

Mettre en place une démarche de qualité des données sur un référentiel client, avec règles, responsabilités et suivi des corrections.
...
### Mesurer la qualité selon les usages · 210 min
...
### Construire les contrôles et le traitement des anomalies · 210 min
...
- Les règles correspondent à un usage explicite.
- La correction s'accompagne d'une action sur la cause.
- Les indicateurs permettent de vérifier l'amélioration dans le temps.
...
[Fiche officielle observée le 11 septembre 2026](https://beyond-expertise.com/formations/data-quality-et-gouvernance-des-donnees)
