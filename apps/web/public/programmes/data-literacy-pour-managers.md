...
Public : Managers, responsables d’équipe, directions métier, chefs de projet.

Prérequis de la fiche : Utiliser régulièrement des indicateurs ou reportings dans son activité.

## Préparation de la formation

Aucun prérequis statistique ; tableaux et graphiques fictifs, calculatrice ou tableur.

## Cas fil rouge

Lire un tableau de bord de direction et poser les questions nécessaires avant de prendre une décision.
...
### Comprendre ce qu'un indicateur mesure · 105 min
...
- Les unités et dénominateurs sont correctement lus.
- Les conclusions dépassant les données sont repérées.
- La décision distingue fait, hypothèse et information à obtenir.
...
[Fiche officielle observée le 11 septembre 2026](https://beyond-expertise.com/formations/data-literacy-pour-managers)
