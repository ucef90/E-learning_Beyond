...
Public : Product managers, product owners, analysts produit, growth teams, business analysts.

Prérequis de la fiche : Avoir deja travaille sur un produit digital, des KPI ou des usages analytics.

## Préparation de la formation

Tableur et lecture de statistiques descriptives ; données d'événements synthétiques, aucun trafic réel requis.

## Cas fil rouge

Évaluer une modification du parcours d'inscription d'un produit numérique, de l'instrumentation à la décision de déploiement.
...
### Définir le parcours et son instrumentation · 210 min
...
### Lire les résultats sans faux signal · 210 min
...
- Le protocole permet de distinguer hypothèse et analyse exploratoire.
- La conclusion exprime l'incertitude et les effets métier.
- Les contrôles de qualité précèdent toute recommandation produit.
...
[Fiche officielle observée le 11 septembre 2026](https://beyond-expertise.com/formations/product-analytics-et-experimentation-ab-testing)
...
- [Microsoft Research · expérimentation contrôlée](https://www.microsoft.com/en-us/research/group/experimentation-platform-exp/)
