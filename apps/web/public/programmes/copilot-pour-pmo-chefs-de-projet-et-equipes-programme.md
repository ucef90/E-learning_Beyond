...
Public : PMO, chefs de projet, responsables programme, directions transformation.

Prérequis de la fiche : Avoir deja pratique la gestion de projet ou la production de reportings projet.

## Préparation de la formation

Pratique du pilotage projet et de Microsoft 365 ; compte et fonctions vérifiés, documents d'exercice fournis lors de l'atelier.

## Cas fil rouge

Préparer un comité de pilotage avec Copilot à partir d'un planning, d'un registre de risques et de comptes rendus fictifs.
...
### Préparer un dossier projet exploitable · 105 min
...
- Chaque alerte correspond à un fait source.
- Les arbitrages sont formulés comme des décisions explicites.
- La validation humaine précède toute diffusion.
...
[Fiche officielle observée le 11 septembre 2026](https://beyond-expertise.com/formations/copilot-pour-pmo-chefs-de-projet-et-equipes-programme)
