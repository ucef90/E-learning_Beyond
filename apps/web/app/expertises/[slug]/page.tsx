        ...
        <section style={{ marginTop: 48 }}>
          <div className="section-heading-row">
            <div>
              ...
              <p className="section-copy" style={{ marginBottom: 0 }}>
                Une selection reliee directement au catalogue Beyond Expertise
                pour capter les recherches intentionnelles et orienter vers les
                bonnes fiches.
              </p>
            </div>
            <Link href="/formations" className="button button-secondary">
        ...
        <section className="catalog-highlight" style={{ marginTop: 48 }}>
          <div>
            ...
            <h2 className="section-title" style={{ maxWidth: "12ch" }}>
              Construire un parcours sur-mesure autour de {hub.shortLabel}.
            </h2>
            <p className="section-copy">
              Beyond Expertise peut transformer cette expertise en parcours
              intra, programme blended, academie metier ou offre combinee
              catalogue + coaching + ressources e-learning.
            </p>
          </div>
          <div className="catalog-highlight-list">
            <Link href="/devis" className="catalog-highlight-item">
              ...
              <span>
                Construire un parcours adapte a votre maturite, vos profils et
                vos objectifs.
              </span>
            </Link>
            <Link href="/contact" className="catalog-highlight-item">
              ...
              <span>
                Qualifier vos besoins et orienter les bons publics vers les
                bonnes formations.
              </span>
            </Link>
            <Link href="/expertises" className="catalog-highlight-item">
              ...
              <span>
                Copilot, AI Agents, AI Security, Lakehouse, LLMOps et autres
                univers premium.
              </span>
            </Link>
          </div>
