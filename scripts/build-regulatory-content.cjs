...
const courses = meta.courses.map((c) => {
  ...
  write(`content/exports/programmes/${c.slug}.md`, programme);
  write(`content/exports/reglementation/${c.code}-support.md`, support);
  write(`content/exports/reglementation/${c.code}-modeles.md`, models);
  return {
    ...c,
    training,
    syllabus,
