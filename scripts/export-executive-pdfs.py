...
def footer(c,doc):
    ...
    c.setFont('Beyond',7);c.drawString(44,35,'BEYOND EXPERTISE - SIREN 932 551 674 - NDA 11770976077 (ne vaut pas agrement de l Etat)');c.drawString(44,24,'23 rue Marcel Houdet, 77000 Melun - Programme du 13 septembre 2026');c.drawRightString(551,24,str(doc.page))
