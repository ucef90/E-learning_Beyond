# Accueil — rapprochement avec le site officiel
Date : 12 septembre 2026. Référence inspectée : https://beyond-expertise.com/ (DOM, capture, vidéo et styles).
...
## Informations confirmées par le porteur
- Missions réalisées par les formateurs de Beyond Expertise, missionnés par Beyond, notamment en sous-traitance. Cette relation est expliquée dans le bloc références, sans présenter chaque organisation comme client contractuel direct.
- Les avis et taux de satisfaction du site officiel reposent sur un suivi interne que le porteur ne souhaite pas partager. La moyenne générale de 4,8/5 est reprise comme donnée du centre. La période et le nombre de réponses ne sont pas publiés.
- La note de 4,9 affichée sur la carte officielle n’est pas attribuée sans détail à un cours. La carte locale montre explicitement la note globale du centre, 4,8/5.
- Les 94 % de réussite et 8 000 apprenants annuels ne sont pas repris : la réponse reçue confirme la satisfaction, pas les effectifs ni la réussite.
- Qualiopi : finalisation en cours, certification non acquise. Badge de statut propre au site, pas le logo de certification réservé aux titulaires.
- CPF / OPCO : possibilités à étudier, pas d’éligibilité générale annoncée.

## Sources et médias
- Page officielle : https://beyond-expertise.com/
- Vidéo originale : https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260328_105406_16f4600d-7a92-4292-b96e-b19156c7830a.mp4
- Pictogrammes de marques : mêmes favicons que le site officiel, téléchargés depuis icons.duckduckgo.com et servis localement.
- Logo Médiamétrie : https://www.mediametrie.fr/themes/custom/mediametrie/new_logo.svg
- Photo d’illustration, Campaign Creators, licence Unsplash : https://unsplash.com/photos/people-sitting-near-table-with-laptop-computer-qCi_MzVODoU
- Image : https://images.unsplash.com/photo-1542744095-fcf48d80b0fd
- Qualiopi, règles d’usage : https://travail-emploi.gouv.fr/qualiopi-usage-de-la-marque
- Qualité et financement : https://travail-emploi.gouv.fr/referentiel-national-qualite-guide-de-lecture-qualiopi

Aucune modification du site original en ligne, de son dépôt local ni des données des cours / apprenants. Les contenus RGPD / AI Act et les procédures qualité sont conservés.
